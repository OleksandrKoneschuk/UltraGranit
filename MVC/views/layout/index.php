    ...
    <div class="container">
        ...
        <nav>
            <ul class="nav">
                ...
                <li class="nav-item"><a class="header-link <?= strpos($current_page, '/about') === 0 ? 'active' : '' ?>"
                ...
                <li class="nav-item"><a class="header-link <?= strpos($current_page, '/basket/view') === 0 ? 'active' : '' ?>"
